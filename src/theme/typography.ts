...
export const textRoles: Record<'display' | 'title' | 'headline' | 'body' | 'label' | 'caption', TextRole> = {
  display: { fontFamily: fontFamilies.bold, fontSize: 44, lineHeight: 46, fontWeight: '700', letterSpacing: -1.1 },
  ...
  caption: { fontFamily: fontFamilies.thin, fontSize: 12, lineHeight: 16, fontWeight: '300', letterSpacing: 0.2 },
} as const;
